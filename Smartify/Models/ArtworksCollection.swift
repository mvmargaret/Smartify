...
class ArtworksCollection {
    ...
    var artwork: [Artwork] = [
        Artwork(imageName: "starry-night", name: "The Starry Night", author: "Vincent van Gogh", imageOfAuthor: "van-gogh", aboutDetails: """
...
""", imageOfGallery: "tretyakovgallery", placeOfStorage: "Tretyakov Gallery, Moscow"),
